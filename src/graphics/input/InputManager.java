    ...
    MouseMotionListener, MouseWheelListener
{
    ...
    */
    ...
    private graphics.input.GameAction[] keyActions =
        new graphics.input.GameAction[NUM_KEY_CODES];
    private graphics.input.GameAction[] mouseActions =
        new graphics.input.GameAction[NUM_MOUSE_CODES];
    ...
    */
    ...
    /**
        ...
        it.
    */
    public void mapToKey(graphics.input.GameAction gameAction, int keyCode) {
    ...
    /**
        ...
        it.
    */
    public void mapToMouse(graphics.input.GameAction gameAction,
                           int mouseCode)
    {
    ...
    /**
        ...
        GameAction.
    */
    public void clearMap(graphics.input.GameAction gameAction) {
    ...
    */
    public List getMaps(graphics.input.GameAction gameCode) {
    ...
    */
    ...
    private graphics.input.GameAction getKeyAction(KeyEvent e) {
    ...
    */
    ...
    private graphics.input.GameAction getMouseButtonAction(MouseEvent e) {
    ...
    public void keyPressed(KeyEvent e) {
        graphics.input.GameAction gameAction = getKeyAction(e);
        if (gameAction != null) {
            gameAction.press();
        }
    ...
    public void mousePressed(MouseEvent e) {
        graphics.input.GameAction gameAction = getMouseButtonAction(e);
        if (gameAction != null) {
            gameAction.press();
        }
    }
    ...
    private void mouseHelper(int codeNeg, int codePos,
        int amount)
    {
        graphics.input.GameAction gameAction;
        if (amount < 0) {
